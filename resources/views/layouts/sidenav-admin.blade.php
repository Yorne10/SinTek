...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-3">
            ...
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="{{ asset('assets/img/team/profile-picture-3.jpg') }}"
                        ...
                        alt="{{ auth()->user()->first_name ?? 'Administrador' }}">
                </div>
                <div class="d-block">
                    <h2 class="h5 mb-3">Hola, {{ auth()->user()->first_name ?? 'Administrador' }}</h2>
                    <form method="POST"
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            {{-- Configuración --}}
            <li class="nav-item">
                <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.admin.configuration') }}"
                    class="nav-link">
