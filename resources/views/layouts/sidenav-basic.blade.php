...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-3">
        <div
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-block">
                    ...
                    <form method="POST"
                        action="{{ route(config('proj.route_name_prefix', 'proj') . '.auth.logout') }}">
                        @csrf
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.billing.transactions') }}"
                    class="nav-link">
                    <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse" role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.bootstrap-tables') }}">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse" role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.profile.example') }}">
                                <span class="sidebar-text">Profile</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.examples.register') }}">
                                <span class="sidebar-text">Sign Up</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.examples.forgot-password') }}">
                                <span class="sidebar-text">Forgot password</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.examples.reset-password') }}">
                                <span class="sidebar-text">Reset password</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.auth.lock') }}">
                                <span class="sidebar-text">Lock</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.errors.404') }}">
                                <span class="sidebar-text">404 Not Found</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.errors.500') }}">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ Request::segment(1) == 'buttons' || Request::segment(1) == 'notifications' || Request::segment(1) == 'forms' || Request::segment(1) == 'modals' || Request::segment(1) == 'typography' ? 'show' : '' }}"
                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.buttons') }}">
                                <span class="sidebar-text">Buttons</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.notifications') }}">
                                <span class="sidebar-text">Notifications</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.forms') }}">
                                <span class="sidebar-text">Forms</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.modals') }}">
                                <span class="sidebar-text">Modals</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ route(config('proj.route_name_prefix', 'proj') . '.ui.typography') }}">
            ...
            <li class="nav-item">
                <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon me-2">
                        <img class="me-2" src="{{ asset('assets/img/themesberg.svg') }}" height="20"
                            width="20" alt="Themesberg Logo">
                    </span>
            ...
            <li class="nav-item">
                <a href="https://updivision.com" target="_blank" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon me-2">
                        <img class="me-2" src="{{ asset('assets/img/updivision.png') }}" height="20"
                            width="20" alt="Themesberg Logo">
                    </span>
