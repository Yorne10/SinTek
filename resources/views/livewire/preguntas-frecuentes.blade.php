                ...
                <div class="col-12">
                    <div class="card border-0 shadow">
                        ...
                        <div class="card-body">
                            ...
                            @else
                                <p class="text-muted text-center mb-0">No hay preguntas frecuentes en esta categoría.</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Pronto se agregarán preguntas frecuentes para ayudarte.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow">
                    <div class="card-body text-center py-5">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" wire:click="$set('search', '')">Limpiar búsqueda</button>
                    </div>
                </div>
            </div>
        </div>
