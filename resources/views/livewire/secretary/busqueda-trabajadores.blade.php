        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-12 col-lg-9 d-flex flex-wrap gap-2">
                <div class="input-group me-2 fmxw-300">
                    ...
                    <input wire:model.live.debounce.400ms="search" type="text" class="form-control" placeholder="Buscar por nombre o email">
                </div>
                <input wire:model.live.debounce.400ms="searchCurp" type="text" class="form-control fmxw-200" placeholder="CURP" maxlength="18">
                <input wire:model.live.debounce.400ms="searchRfc" type="text" class="form-control fmxw-150" placeholder="RFC" maxlength="13">
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        <table class="table user-table table-hover align-items-center">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom">Teléfono</th>
                    ...
                    <td>
                        @if($worker->positions && $worker->positions->count() > 0)
                            ...
                            <div class="d-flex flex-column gap-1">
                                ...
                                @endforeach
                                @if($totalPositions > 2)
                                    <span class="small text-gray-600">+{{ $totalPositions - 2 }} más</span>
                                @endif
                            </div>
                        @else
        ...
        <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
            ...
            <div class="fw-normal small mt-4 mt-lg-0">
                Mostrando <b>{{ $workers->firstItem() ?? 0 }}</b> a <b>{{ $workers->lastItem() ?? 0 }}</b> de <b>{{ $workers->total() }}</b> trabajadores
            </div>
        </div>
    </div>
</div>
