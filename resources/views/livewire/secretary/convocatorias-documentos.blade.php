                    ...
                    <form wire:submit.prevent="save">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea wire:model="descripcion" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" rows="4" placeholder="Descripción detallada de la convocatoria..."></textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row mb-2" wire:key="doc-{{ $index }}">
                                    <div class="col-md-5">
                                        <input type="text" wire:model="documentos.{{ $index }}.titulo" class="form-control @error('documentos.'.$index.'.titulo') is-invalid @enderror" placeholder="Título del documento">
