                                ...
                                <div class="d-block mb-4 mb-md-0">
                                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                                        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Bitácora de
                                                actividades</li>
                                        </ol>
                                    </nav>
                                    ...
                                    <tbody>
                                        @forelse($logs as $log)
                                            <tr>
                                                <td>
                                                    <span
                                                        class="fw-bold text-gray-900 text-truncate d-inline-block w-100">{{ $log->user->name ?? 'Sistema' }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="fw-normal text-dark text-truncate d-inline-block w-100">{{ $this->getRoleLabel($log->user->role ?? 'system') }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="fw-normal text-truncate d-inline-block w-100">{{ \App\Services\ActivityLogger::getActionLabel($log->action ?? '') }}</span>
                                                </td>
                                                <td>
                                                    <span class="fw-normal text-truncate d-inline-block w-100"
                                                        title="{{ $log->description ?? '-' }}">{{ $log->description ?? '-' }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="fw-normal">{{ $log->created_at->format('d/m/Y H:i') }}</span>
                                                </td>
                                                <td>
                                                    <div class="btn-group">
                                                        <button
                                                        ...
                                                        <div
                                                            ...
                                                            <button
                                                                class="dropdown-item d-flex align-items-center view-log-detail"
                                                                type="button"
