        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bitcora de auditora</li>
                </ol>
            </nav>
            <h2 class="h4">Bitcora de auditora</h2>
            ...
            <div class="row mb-4">
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Buscar en bitcora...">
                    </div>
                </div>
                <div class="col-md-3 mb-3 mb-md-0">
                    <select class="form-select" id="filter_action_type">
                        <option value="" selected>Todas las acciones</option>
                        <option value="create">Creacin</option>
                        <option value="update">Actualizacin</option>
                        <option value="delete">Eliminacin</option>
                        <option value="login">Inicio de sesin</option>
                        <option value="logout">Cierre de sesin</option>
                        <option value="approve">Aprobacin</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Alfonso Garca</span>
                                        <small class="text-gray-500">alfonso.garcia@cetam.gob.mx</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-success">Creacin</span>
                            </td>
                            <td class="text-gray-900">Procesos</td>
                            <td class="text-gray-700">
                                Cre el proceso "Solicitud de vacaciones" (SOL-VAC-001)
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Mara Lpez</span>
                                        <small class="text-gray-500">maria.lopez@cetam.gob.mx</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="badge badge-approved">Aprobacin</span>
                            </td>
                            <td class="text-gray-900">Trmites</td>
                            <td class="text-gray-700">
                                Aprob la solicitud de vacaciones #SV-2025-0045
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Juan Prez</span>
                                        <small class="text-gray-500">juan.perez@cetam.gob.mx</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-info">Actualizacin</span>
                            </td>
                            <td class="text-gray-900">Usuarios</td>
                            <td class="text-gray-700">
                                Actualiz el perfil del usuario "Laura Hernndez"
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Carlos Martnez</span>
                                        <small class="text-gray-500">carlos.martinez@cetam.gob.mx</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-secondary">Inicio de sesin</span>
                            </td>
                            <td class="text-gray-900">Autenticacin</td>
                            <td class="text-gray-700">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Ana Rodrguez</span>
                                        <small class="text-gray-500">ana.rodriguez@cetam.gob.mx</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-danger">Eliminacin</span>
                            </td>
                            <td class="text-gray-900">Documentos</td>
                            <td class="text-gray-700">
                                Elimin el documento "Convocatoria 2024-Q4.pdf"
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Luis Snchez</span>
                            ...
                            <td class="text-gray-900">Trmites</td>
                            <td class="text-gray-700">
                                Rechaz la solicitud de reembolso #RG-2025-0089
                            </td>
                            <td class="text-gray-500">192.168.1.105</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-link text-gray-600 p-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Sofa Torres</span>
                            ...
                            <td class="text-gray-900">Usuarios</td>
                            <td class="text-gray-700">
                                Cre el usuario "Pedro Ramrez" con rol de Trabajador
                            </td>
                            <td class="text-gray-500">192.168.1.098</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-link text-gray-600 p-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold">Roberto Daz</span>
                            ...
                            <td class="text-gray-900">Configuracin</td>
                            <td class="text-gray-700">
                                Modific parmetros de seguridad del sistema
                            </td>
                            <td class="text-gray-500">192.168.1.112</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-link text-gray-600 p-0">
    ...
    <div class="row">
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <h2 class="h6 mb-0">Acciones ms frecuentes</h2>
                        <span class="badge bg-secondary">ltimos 30 das</span>
                    </div>
                    <div class="mt-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-normal small">Inicio de sesin</span>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-normal small">Aprobacin</span>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-normal small">Actualizacin</span>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-normal small">Creacin</span>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-normal small">Eliminacin</span>
                            </div>
        ...
        <div class="col-12 col-xl-4 mb-4">
            <div class="card border-0 shadow">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <h2 class="h6 mb-0">Usuarios ms activos</h2>
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="fw-bold small">Alfonso Garca</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="fw-bold small">Mara Lpez</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="fw-bold small">Juan Prez</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="fw-bold small">Ana Rodrguez</span>
                                    <small class="text-gray-500">Secretaria</small>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="fw-bold small">Carlos Martnez</span>
                                    <small class="text-gray-500">Trabajador</small>
                                </div>
                            </div>
        ...
        <div class="col-12 col-xl-4 mb-4">
            <div class="card border-0 shadow">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <h2 class="h6 mb-0">Mdulos ms utilizados</h2>
                        <span class="badge bg-secondary">Esta semana</span>
                    </div>
                    <div class="mt-3">
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-1">
                                <span class="small">Trmites</span>
                        ...
                        <div>
                            <div class="d-flex justify-content-between mb-1">
                                <span class="small">Configuracin</span>
