        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Parmetros y configuracin</li>
                </ol>
            </nav>
            <h2 class="h4">Parmetros y configuracin</h2>
    ...
    <div class="row">
                ...
                <form>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                <label for="institution_name">Nombre de la institucin</label>
            ...
            <div class="card card-body shadow border-0 mb-4">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                <label for="max_attempts">Intentos mximos de login</label>
        ...
        <div class="col-12 col-xl-4">
            ...
            <div class="card card-body shadow border-0">
                <h2 class="h5 mb-4">Informacin del sistema</h2>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0 border-bottom">
                        <div>
                            <h3 class="h6 mb-1">Versin</h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Botn de guardar informacin general
    document.getElementById('saveGeneralBtn')?.addEventListener('click', function() {
        swalWithBootstrapButtons.fire({
            title: 'Guardar cambios?',
            text: 'Deseas guardar los cambios en la informacin general?',
            icon: 'question',
    ...
    // Botn de guardar configuracin de seguridad
    document.getElementById('saveSecurityBtn')?.addEventListener('click', function() {
        swalWithBootstrapButtons.fire({
            title: 'Actualizar configuracin?',
            text: 'Deseas actualizar la configuracin de seguridad?',
            icon: 'question',
            showCancelButton: true,
    ...
    // Escuchar evento de notificacin de configuracin
    if (window.Livewire) {
