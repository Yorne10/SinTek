    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            <div class="card card-body shadow border-0 mb-4">
                <h2 class="h5 mb-4">Informacin del paso</h2>
                <form wire:submit.prevent="save">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <small class="form-text text-muted">Selecciona el proceso al que pertenecer este paso.</small>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <label for="nombre_paso">Nombre del paso</label>
                            <input class="form-control" id="nombre_paso" type="text" placeholder="Ej: Revisin de supervisor" wire:model="tittle">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <small class="form-text text-muted">Posicin en el flujo.</small>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="tipo_paso" wire:model.live="condition_type">
                                ...
                                <option value="approval">Aprobacin</option>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <small class="form-text text-muted">Estas instrucciones sern mostradas al usuario responsable.</small>
                        </div>
                    </div>

                    <hr class="my-4">
                    <h2 class="h5 mb-3">Configuracin de flujo</h2>
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="activar_ramificacion">
                                    Activar ramificacin condicional
                                </label>
                            </div>
                            <small class="form-text text-muted">Permite que el paso tenga diferentes caminos segn la decisin tomada.</small>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="card border-light shadow-sm">
                                <div class="card-body">
                                    <h3 class="h6 mb-3">Configuracin de ramificacin</h3>
                                    <p class="small text-gray-700 mb-3">
                                        ...
                                        Este paso puede tener diferentes caminos segn la decisin (aprobado/rechazado).
                                    </p>
                                    ...
                                    <div class="alert alert-warning" role="alert">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="small mb-2">An no existen otros pasos en este proceso. Puedes:</p>
                                                <ul class="small mb-0 ps-3">
                                                    <li>Guardar este paso ahora y configurar la ramificacin despus</li>
                                                    <li>Crear primero otros pasos y luego volver a editar este para configurar la ramificacin</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <hr class="my-4">
                    <h2 class="h5 mb-3">Configuracin adicional</h2>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="tiempo_limite">Tiempo lmite (das)</label>
                            ...
                            <small class="form-text text-muted">Das hbiles para completar este paso.</small>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="form-text text-muted">El paso solicita documentos especficos.</small>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info" role="alert">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="small">Este paso requerir documentos adjuntos. La gestin de documentos especficos se configurar en una versin futura.</span>
                        </div>
                    </div>
                    @endif
        ...
        <div class="col-12 col-xl-4">
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body">
                    <p class="small text-gray-700 mb-3">Cada tipo de paso tiene un propsito especfico en el flujo de trabajo:</p>
                        ...
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small mb-0">El usuario completa campos y proporciona informacin.</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h3 class="h6 mb-1">Aprobacin</h3>
                                    <p class="small mb-0">Requiere una decisin de aprobacin (S/No). Ideal para flujos condicionales.</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h3 class="h6 mb-1">Validacin</h3>
                                    <p class="small mb-0">Verificacin de requisitos o condiciones especficas.</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small mb-0">El usuario debe subir documentos especficos requeridos.</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h3 class="h6 mb-1">Comunicacin</h3>
                                    <p class="small mb-0">Envo de notificaciones o informacin a usuarios.</p>
                                </div>
                            </div>
                        </li>
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <p class="small text-gray-700 mb-2">
                        Los pasos condicionales solo pueden ejecutarse si estn configurados con ramificacin activada.
                    </p>
                    <p class="small text-gray-700 mb-0">
                        El tipo "Aprobacin" es ideal para flujos condicionales ya que permite definir diferentes caminos segn la decisin tomada (aprobado/rechazado).
                    </p>
                </div>
            </div>
        </div>
