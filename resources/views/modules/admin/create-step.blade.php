            ...
            <div class="card card-body shadow border-0 mb-4">
                ...
                <form wire:submit.prevent="save">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @php
                                ...
                                $initialStepCount = \App\Models\Step::where('process_id', $process_id)
                                    ->where(function ($q) {
                                        $q->where('step_type', 'initial')->orWhere('is_initial_step', 1);
                                    })
                            ...
                            <select class="form-select @error('step_type') is-invalid @enderror" id="step_type"
                                wire:model.live="step_type" @if ($isEditing) disabled @endif>
                    ...
                    @if ($step_type === 'final')
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="finalization_message">Mensaje de finalización <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control @error('finalization_message') is-invalid @enderror" id="finalization_message"
                                    rows="3" placeholder="Mensaje que se mostrará al usuario cuando el proceso termine..."
                    ...
                    @if ($step_type === 'conditional')
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="condition_question">Pregunta condicional <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3" wire:key="provided-doc-{{ $index }}">
                                ...
                                <div class="d-flex gap-2 align-items-start">
                                    <div class="flex-grow-1">
                                        <input type="file"
                                            wire:model="providedDocuments.{{ $index }}.archivo"
