    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                                    ...
                                    <div class="d-flex align-items-stretch justify-content-between flex-wrap gap-2">
                                        <div>
                                            ...
                                            @if ($selectedProcess->category)
                                                <p class="small text-gray mb-0">Categoría:
                                                    {{ ucfirst($selectedProcess->category) }}
                                                </p>
                                            @endif
                                            @if ($selectedProcess->department)
                                                <p class="small text-gray mb-0">Área responsable:
                                            ...
                                            <div class="btn-group position-static">
                                                ...
                                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-step-initial="{{ $step->is_initial_step ? 'Sí' : 'No' }}"
                                                        data-step-linked="{{ $step->is_linked ? 'Sí' : 'No' }}"
                                                        data-step-docs="{{ $step->requiredDocuments->count() ?? 0 }}"
                                                        data-step-provided-docs="{{ $providedDocs }}"
                                                        data-step-next="{{ $nextStep }}" data-step-next-yes="{{ $nextYes }}"
                ...
                <script>
                    ...
                    `;
                                ...
                                if (finalization) {
                                    htmlContent += `<p class="mb-2"><span class="fw-bold">Mensaje de finalización:</span> ${finalization}</p>`;
                                }

                                // Show next step info based on step type
                                if (type === 'conditional') {
                                    htmlContent += `<p class="mb-2"><span class="fw-bold">Si SÍ:</span> ${nextYes || 'No definido'}</p>`;
