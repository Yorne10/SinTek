...
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.admin.crear-paso') }}"
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                                        <a class="dropdown-item d-flex align-items-center"
                                                            href="{{ route(config('proj.route_name_prefix', 'proj') . '.admin.crear-paso', ['step_id' => $step->step_id]) }}">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            @if($selectedProcessId)
                                <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.admin.crear-paso', ['process_id' => $selectedProcessId]) }}"
