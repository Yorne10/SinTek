                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="small text-gray mb-0">
                                ...
                                Cdigo: {{ $selectedProcess->process_code }}
                                @endif
                                @if($selectedProcess->category)
                                | Categora: {{ ucfirst($selectedProcess->category) }}
                                @endif
                            </p>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body p-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($step->condition_type === 'approval')
                                            <span class="fw-bold text-warning">Aprobacin</span>
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-gray-600 mb-3">Este proceso an no tiene pasos configurados.</p>
                        ...
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small text-gray-600 mb-0">El usuario completa campos de informacin</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small text-gray-600 mb-0">Requiere una decisin de aprobacin</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0 border-bottom pb-3">
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        @icon('state.info', 'icon icon-xs text-primary me-2 mt-1 flex-shrink-0')
                        <p class="small text-gray-700 mb-0">
                            El paso de tipo "Final" debe ser el ltimo paso del proceso.
                        </p>
                    </div>
                </div>
            </div>
