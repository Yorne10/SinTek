            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                ...
                                <p class="mb-0">Proporciona tus datos institucionales. Te enviaremos un correo de verificacin y un secretario aprobar tu alta.</p>
                            </div>
                            <form wire:submit="register">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="password" wire:model.lazy="password" type="password" placeholder="Mnimo 8 caracteres" class="form-control" id="password" required>
                                    </div>  
                                    @error('password') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                                </div>
                                <!-- Confirmacin -->
                                <div class="form-group mb-3">
                                    <label for="confirm_password">Confirmar contrasea</label>
                                    <div class="input-group">
                                        ...
                                        <input name="password_confirmation" wire:model.lazy="passwordConfirmation" type="password" placeholder="Repite la contrasea" class="form-control" id="confirm_password" required>
                                    </div>  
                                </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Ya tienes cuenta?
                                    <a href="{{ route(config('proj.route_name_prefix', 'proj').'.auth.login') }}" class="fw-bold">Inicia sesin</a>
                                </span>
                            </div>
                        </div>
                    </div>
