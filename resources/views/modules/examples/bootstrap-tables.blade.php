{{--
    Company: CETAM
    Project: ST
    File: bootstrap-tables.blade.php
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-12 col-xl-10 px-0 px-xl-1">
                                        <div class="progress progress-lg mb-0">
                                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="51"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-12 col-xl-10 px-0 px-xl-1">
                                        <div class="progress progress-lg mb-0">
                                            <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="18"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-12 col-xl-10 px-0 px-xl-1">
                                        <div class="progress progress-lg mb-0">
                                            <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="8"
                    ...
                    <tbody>
                            ...
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('assets/img/flags/united-states-of-america.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('assets/img/flags/canada.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('assets/img/flags/united-kingdom.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('assets/img/flags/japan.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('assets/img/flags/germany.svg') }}">
