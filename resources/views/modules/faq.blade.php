...
<div>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">Encuentra respuestas a las preguntas m&aacute;s comunes sobre el sistema y
                tr&aacute;mites.</p>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                                    ...
                                    @foreach ($categoryFaqs as $faq)
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse{{ $faq->faq_id }}" class="accordion-collapse collapse"
                                                ...
                                                data-bs-parent="#faqCategory{{ $category->faq_category_id }}">
                            ...
                            @else
                                <p class="text-muted text-center mb-0">No hay preguntas frecuentes en esta
                                    categor&iacute;a.</p>
                            @endif
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">No se encontraron preguntas frecuentes que coincidan con
                            "{{ $search }}".</p>
                        <button type="button" class="btn btn-primary btn-sm" wire:click="$set('search', '')">Limpiar
