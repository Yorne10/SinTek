...
<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <div class="row justify-content-center form-bg-image">
            <p class="text-center"><a href="{{ route(config('proj.route_name_prefix', 'proj') . '.auth.login') }}"
                    class="text-gray-700"><i class="fas fa-angle-left me-2"></i> Back to log in</a></p>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input wire:model="email" type="email" class="form-control"
                                    placeholder="example@company.com" id="email" required autofocus>
                            </div>
                            @error('email')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model.lazy="passwordConfirmation" type="password"
                                    placeholder="Confirm Password" class="form-control" id="password_confirmation"
                                    required>
                            </div>
                        </div>
                        <!-- End of Form -->
