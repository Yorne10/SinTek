                    ...
                    <div class="d-block mb-4 mb-md-0">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                                ...
                                <li class="breadcrumb-item">
                                    <a
                                        href="{{ route(config('proj.route_name_prefix', 'proj') . '.secretary.calls') }}">
                                        Convocatorias
                                    </a>
                                </li>
                        ...
                        <p class="mb-0">{{ $convocationId ? 'Actualiza los detalles de la' : 'Crea una nueva' }}
                            convocatoria en
                            el
                            sistema.</p>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea wire:model="descripcion"
                                                ...
                                                placeholder="Descripción detallada de la convocatoria..."></textarea>
                                            @error('descripcion')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check">
                                                <input wire:model.live="convocatoria_permanente"
                                                    class="form-check-input" type="checkbox"
                                                    id="convocatoria_permanente"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input wire:model="fecha_fin" type="date"
                                                ...
                                                id="fecha_fin" @if ($convocatoria_permanente) disabled @endif>
                                            @error('fecha_fin')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @foreach ($documentosExistentes as $docExistente)
                                                        <div class="mb-2 d-flex justify-content-between align-items-center small"
                                                            wire:key="existing-doc-{{ $docExistente['id'] }}">
                                                            <div>
                                                                <span>Título del documento:</span>
                                                                <span class="ms-1">{{ $docExistente['titulo'] }}</span>
                                                            </div>
                                                            <button type="button" class="btn btn-sm btn-danger btn-delete-doc"
                                            ...
                                            <label
                                                class="form-label">{{ $convocationId ? 'Agregar nuevos documentos' : 'Documentos (PDF)' }}
                                                    ...
                                                    <div class="d-flex gap-2 align-items-start">
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div wire:loading wire:target="documentos.{{ $index }}.archivo"
                                                                class="text-gray-600 small mt-1">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-700 small mb-0">
                                                        Puedes eliminar documentos existentes y agregar nuevos documentos a
                                                        esta convocatoria.
                                                    </p>
                                                </div>
                                            </div>
                    ...
                    document.getElementById('saveConvBtn')?.addEventListener('click', function (e) {
                        ...
                        if (fileUploading) {
                            Swal.fire({
                                ...
                                text: 'Por favor espera a que terminen de cargar los archivos PDF antes de guardar.',
                                icon: 'warning',
