...
<div>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Gestin de convocatorias y documentos</h2>
            <p class="mb-0">Administra las convocatorias pblicas y documentos institucionales.</p>
        </div>
    </div>
                    ...
                    <form wire:submit.prevent="save">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="titulo" class="form-label">Ttulo de la convocatoria *</label>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="descripcion" class="form-label">Descripcin *</label>
                                <textarea wire:model="descripcion" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" rows="4" placeholder="Descripcin detallada de la convocatoria..."></textarea>
                                @error('descripcion') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-12 mb-3">
                                <div class="form-check">
                                    <input wire:model.live="convocatoria_permanente" class="form-check-input" type="checkbox" id="convocatoria_permanente">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input wire:model="fecha_fin" type="date" class="form-control @error('fecha_fin') is-invalid @enderror" id="fecha_fin" @if($convocatoria_permanente) disabled @endif>
                                <small class="form-text text-muted">Dejar vaco si es permanente</small>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row mb-2" wire:key="doc-{{ $index }}">
                                    <div class="col-md-5">
                                        <input type="text" wire:model="documentos.{{ $index }}.titulo" class="form-control @error('documentos.'.$index.'.titulo') is-invalid @enderror" placeholder="Ttulo del documento">
                                ...
                                <button type="button" wire:click="addDocumento" class="btn btn-sm btn-outline-primary">
                                    <svg class="icon icon-xs me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                    Agregar documento
                                </button>
                            </div>
                            ...
                            <div class="col-md-12 d-flex justify-content-end gap-2">
                                <button type="button" wire:click="limpiar" class="btn btn-secondary">
                                    <svg class="icon icon-xs me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd"></path></svg>
                                    Limpiar
                                </button>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="border-bottom">Ttulo</th>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-block">
                                            ...
                                            <div class="small text-gray">{{ Str::limit($convocatoria->description, 80) }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="fw-normal small">{{ $convocatoria->start_date ? $convocatoria->start_date->format('d/m/Y') : 'N/A' }}</span>
                                        @if($convocatoria->end_date)
                                        <span class="text-gray"> - </span>
                                        <span class="fw-normal small">{{ $convocatoria->end_date->format('d/m/Y') }}</span>
                                        @else
                                    ...
                                    <td>
                                        ...
                                        @elseif($convocatoria->status === 'proxima')
                                            <span class="fw-bold text-warning">Prxima</span>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex gap-1">
                                            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.convocation-document.show', $convocatoria->documents->first()->convocation_document_id) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                            ...
                                            <span class="small text-gray align-self-center">+{{ $convocatoria->documents->count() - 1 }}</span>
                                            @endif
                                        </div>
                                        @else
                    ...
                    <div class="card-footer px-3 border-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="fw-normal small">
                            Mostrando <b>{{ $convocatorias->firstItem() ?? 0 }}</b> a <b>{{ $convocatorias->lastItem() ?? 0 }}</b> de <b>{{ $convocatorias->total() }}</b>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body border-bottom bg-light">
                    <form wire:submit.prevent="saveInstitutionalDocument">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="doc_titulo" class="form-label">Ttulo del documento *</label>
                                <input wire:model="doc_titulo" type="text" class="form-control @error('doc_titulo') is-invalid @enderror" id="doc_titulo" placeholder="Ej: Reglamento Interior de Trabajo">
                                @error('doc_titulo') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="doc_categoria" class="form-label">Categora *</label>
                                <select wire:model="doc_categoria" class="form-select @error('doc_categoria') is-invalid @enderror" id="doc_categoria">
                                    <option value="reglamento">Reglamento</option>
                                    <option value="manual">Manual</option>
                                    <option value="lineamiento">Lineamiento</option>
                                    <option value="codigo">Cdigo</option>
                                    <option value="otro">Otro</option>
                                </select>
                                @error('doc_categoria') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="doc_version" class="form-label">Versin *</label>
                                <input wire:model="doc_version" type="text" class="form-control @error('doc_version') is-invalid @enderror" id="doc_version" placeholder="1.0">
                                @error('doc_version') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="doc_descripcion" class="form-label">Descripcin (opcional)</label>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input wire:model="doc_fecha_vigencia" type="date" class="form-control" id="doc_fecha_vigencia">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="doc_archivo" class="form-label">Archivo PDF *</label>
                                <input wire:model="doc_archivo" type="file" class="form-control @error('doc_archivo') is-invalid @enderror" id="doc_archivo" accept=".pdf">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center justify-content-between px-3 py-3">
                            <div class="d-flex align-items-center">
                                <svg class="icon icon-lg text-danger me-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="btn-group">
                                <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.institutional-document.show', $document->institutional_document_id) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                    <svg class="icon icon-xs me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.institutional-document.download', $document->institutional_document_id) }}" class="btn btn-sm btn-outline-primary">
                                    <svg class="icon icon-xs me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">
                                    <span class="visually-hidden">Ms</span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item text-warning archive-doc-btn" href="#" data-doc-id="{{ $document->institutional_document_id }}" data-doc-title="{{ $document->title }}">Archivar</a></li>
                                </ul>
                            </div>
                        </div>
                        @empty
                        <div class="text-center py-5">
                            ...
                            <p class="small text-gray-600">Sube tu primer documento usando el botn superior</p>
                        </div>
                        @endforelse
                    </div>
                    ...
                    <div class="card-footer px-3 border-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="fw-normal small">
                            Mostrando <b>{{ $institutionalDocuments->firstItem() ?? 0 }}</b> a <b>{{ $institutionalDocuments->lastItem() ?? 0 }}</b> de <b>{{ $institutionalDocuments->total() }}</b>
                        </div>
                    </div>
                    @endif
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Botn crear convocatoria con confirmacin
    ...
    // Botn guardar documento institucional
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.archive-doc-btn')) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                text: `Ests seguro de archivar "${docTitle}"?`,
                icon: 'warning',
                showCancelButton: true,
    ...
    // Escuchar eventos de notificacin
    if (window.Livewire) {
