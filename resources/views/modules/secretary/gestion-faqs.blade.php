        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gestin de FAQs</li>
                </ol>
            </nav>
            <h2 class="h4">Gestin de Preguntas Frecuentes</h2>
                        ...
                        <form wire:submit.prevent="saveCategory">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model="categoryName" class="form-control @error('categoryName') is-invalid @enderror" placeholder="Ej. Trmites generales">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea wire:model="categoryDescription" rows="2" class="form-control @error('categoryDescription') is-invalid @enderror" placeholder="Descripcin breve de la categora"></textarea>
                        ...
                        <form wire:submit.prevent="saveFaq">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" wire:model="faqQuestion" class="form-control @error('faqQuestion') is-invalid @enderror" placeholder="Cmo puedo...?">
                                    @error('faqQuestion') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-12 mb-3">
                                    <label class="form-label fw-semibold">Respuesta</label>
                                    <textarea wire:model="faqAnswer" rows="4" class="form-control @error('faqAnswer') is-invalid @enderror" placeholder="Aqu va la respuesta detallada..."></textarea>
                            ...
                            <tbody>
                                @forelse ($faqs as $faq)
                                    <tr wire:key="faq-{{ $faq->faq_id }}">
                                        ...
                                        <td>
                                            <span class="fw-bold text-info">{{ $faq->category->name ?? 'Sin categora' }}</span>
                                        </td>
