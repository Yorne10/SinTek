 ...
 *   Modified by: Codex |
 *   Description: Envo de notificaciones manuales con buscador y seleccin mltiple.
--}}
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">Busca trabajadores por nombre o correo, agrgalos y enva un mensaje. Tambin puedes enviarlo a todos.</p>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-5 mb-4">
            <div class="card border-0 shadow h-100">
                <div class="card-header bg-white border-0 pb-0">
                    <h2 class="fs-5 fw-bold mb-0">Enviar notificacin</h2>
                    <p class="text-muted small mb-0">Solo ttulo y mensaje; selecciona destinatarios o marca enviar a todos.</p>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="sendNotification">
                        <div class="form-check form-switch mb-3">
                            ...
                            <div class="text-muted small">Si activas esta opcin no necesitas seleccionar usuarios.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">Los resultados aparecen al escribir, no necesitas presionar Enter. Usa Agregar para aadirlos a la lista.</small>
                        </div>
                        ...
                        @if (!$sendToAll)
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    @empty
                                        <span class="text-muted small">An no seleccionas usuarios.</span>
                                    @endforelse
                                </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Ttulo</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea wire:model.defer="message" rows="4" class="form-control @error('message') is-invalid @enderror" placeholder="Explica brevemente al usuario qu debe saber."></textarea>
                            @error('message') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            <small class="text-muted d-block mt-1">Ejemplo: Tu documento ya est listo, puedes pasar por ventanilla.</small>
                        </div>
            ...
            <div class="card border-0 shadow h-100">
                <div class="card-header d-flex align-items-center border-0 pb-0">
                    ...
                    <div class="ms-auto" style="min-width: 240px;">
                        <input wire:model.debounce.500ms="search" type="text" class="form-control form-control-sm" placeholder="Buscar por ttulo o mensaje">
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($notifications as $notification)
                                    <tr wire:key="notification-{{ $notification->notification_id }}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-secondary view-notification-btn" data-notification-id="{{ $notification->notification_id }}" data-notification-title="{{ $notification->tittle ?? 'Sin ttulo' }}" data-notification-message="{{ $notification->message }}" data-notification-user="{{ $notification->user->name ?? 'Usuario' }}" data-notification-date="{{ optional($notification->created_at)->format('d/m/Y H:i') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('sendNotificationBtn')?.addEventListener('click', function(e) {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Enviar notificacin?',
            text: 'Ests seguro de enviar esta notificacin a los usuarios seleccionados?',
            icon: 'question',
