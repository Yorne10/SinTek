                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <svg class="icon icon-lg text-warning" fill="currentColor" viewBox="0 0 20 20"
            ...
            <div class="card border-0 shadow h-100">
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <svg class="icon icon-lg text-info" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
            ...
            <div class="card border-0 shadow h-100">
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <svg class="icon icon-lg text-success" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                                    clip-rule="evenodd"></path>
            ...
            <div class="card border-0 shadow h-100">
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <svg class="icon icon-lg text-primary" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-12 col-lg-9 d-flex flex-wrap gap-2">
                <div class="input-group me-2 fmxw-300">
                    ...
                    <input wire:model.live.debounce.400ms="search" type="text" class="form-control"
                        placeholder="Buscar por folio, trabajador o trámite">
                </div>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        ...
        <div
            ...
            <div class="fw-normal small mt-4 mt-lg-0">
                ...
                <b>{{ $requests->total() }}</b> solicitudes
            </div>
        </div>
    </div>
</div>