...
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">Gestin y revisin de solicitudes de trmites.</p>
        </div>
    </div>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-12 col-lg-9 d-flex flex-wrap gap-2">
                <div class="input-group me-2 fmxw-300">
                    ...
                    <input wire:model.live.debounce.400ms="search" type="text" class="form-control" placeholder="Buscar por folio, trabajador o trmite">
                </div>
        ...
        <table class="table user-table table-hover align-items-center">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom">Trmite</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="fw-normal">{{ $request->process->process_name ?? 'Trmite' }}</span>
                    </td>
                    <td>
