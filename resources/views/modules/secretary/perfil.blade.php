            ...
            <div>
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                    <div class="d-block mb-4 mb-md-0">
                        ...
                        <p class="mb-0">Gestiona tu información personal y preferencias.</p>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-xl-8">
                        ...
                        <div class="card card-body border-0 shadow mb-4">
                            ...
                            <form wire:submit.prevent="save" action="#" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-9 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="user.address" class="form-control" id="address"
                                                type="text" placeholder="Calle y colonia">
                                        </div>
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="user.number" class="form-control" id="number"
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-gray-800 mt-2 animate-up-2">Guardar
                                        cambios</button>
                                </div>
                            </form>
                            ...
                            <div class="col-12 mb-4">
                                <div class="card shadow border-0 text-center p-0">
                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <h5 class="fw-normal">Personal de Secretaría</h5>
