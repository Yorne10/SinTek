                                        ...
                                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                            ...
                                            <button
                                                ...
                                                <span class="spinner-border spinner-border-sm me-2" role="status"
                                                    ...
                                                    wire:target="toggleProcessStatus"></span>
                                                @php($iconClass = $process->active ? 'text-warning' : 'text-success')
                                                @icon($process->active ? 'warning' : 'success', "dropdown-icon {$iconClass} me-2")
