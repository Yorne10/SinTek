...
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Validacin de pasos del trmite</h2>
    ...
    <div class="row">
        <div class="col-12 col-xl-8 mb-4">
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Tipo de trmite</label>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <p class="text-gray-700">Solicitud de vacaciones del 15 al 22 de noviembre de 2025 (8 das hbiles). Motivo: Asuntos personales y familiares.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Progreso del trmite</h2>
                </div>
                <div class="card-body">
                    ...
                    <div class="timeline timeline-one-side">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h3 class="h6 mb-1">Paso 2: Validacin documental</h3>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h3 class="h6 mb-1 text-warning">Paso 3: Revisin de disponibilidad</h3>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h3 class="h6 mb-1 text-gray-500">Paso 4: Aprobacin de supervisor</h3>
            ...
            <div class="card border-0 shadow">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Validacin de pasos</h2>
                </div>
                <div class="card-body">
                    <div class="mb-4 pb-4 border-bottom">
                        ...
                        <p class="text-gray-700 mb-2">Verificar que la solicitud est completa y cumple con los requisitos iniciales.</p>
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <p class="form-control-plaintext text-gray-700">Solicitud recibida correctamente. Todos los documentos estn completos.</p>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="mb-4 pb-4 border-bottom">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h3 class="h6 mb-0">Paso 2: Validacin documental</h3>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold">Observaciones</label>
                                <p class="form-control-plaintext text-gray-700">Documentacin verificada y en regla. INE vigente, comprobante de domicilio actualizado.</p>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Validado por</label>
                                <p class="text-gray-700 mb-0">Mara Lpez Snchez</p>
                    ...
                    <div class="mb-4 pb-4 border-bottom bg-light p-4 rounded">
                        ...
                        <p class="text-gray-700 mb-3">Verificar la disponibilidad de das de vacaciones del trabajador y el impacto en el rea.</p>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <small class="form-text text-gray-500">Describa los hallazgos encontrados en la revisin de disponibilidad.</small>
                                </div>
                                <div class="col-md-12">
                                    <div class="alert alert-info d-flex align-items-center" role="alert">
                                        ...
                                        <div>
                                            <strong>Informacin:</strong> El trabajador tiene 15 das de vacaciones disponibles. Las fechas solicitadas no presentan conflicto con el calendario laboral.
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-4 pb-4 border-bottom">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h3 class="h6 mb-0 text-gray-500">Paso 4: Aprobacin de supervisor</h3>
                        </div>
                        <p class="text-gray-500 mb-0">Este paso estar disponible una vez completado el paso anterior.</p>
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <p class="text-gray-500 mb-0">Este paso estar disponible una vez completados todos los pasos anteriores.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-xl-4">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <small class="text-gray-500">Mara Lpez - 04/11/2025 10:15</small>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <small class="text-gray-500">Mara Lpez - 04/11/2025 09:35</small>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <small class="text-gray-500">Juan Prez - 04/11/2025 09:30</small>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="card border-0 shadow">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Acciones rpidas</h2>
                </div>
                <div class="card-body">
