...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.toggle-user-status')) {
            ...
            const actionText = isActive
                ? `Ests seguro de desactivar al usuario ${userName}? El usuario no podr iniciar sesin.`
                : `Ests seguro de activar al usuario ${userName}? El usuario podr iniciar sesin nuevamente.`;
            const confirmText = isActive ? 'S, desactivar' : 'S, activar';
    ...
    // Escuchar evento de notificacin de usuarios
    if (window.Livewire) {
