                                ...
                                <div class="row d-block d-xl-flex align-items-center">
                                    ...
                                    <div class="col-12 col-xl-7 px-xl-0">
                                        ...
                                        <div class="small d-flex mt-1">
                                            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.mis-tramites') }}"
                                                class="text-primary">Ver detalles</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row d-block d-xl-flex align-items-center">
                                    <div
                                        class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                                        <div class="icon-shape icon-sm rounded me-4 me-sm-0">
                                            @icon('notif.bell', 'fa-lg text-info')
                                        </div>
                                        <div class="d-sm-none">
                                    ...
                                    <div class="col-12 col-xl-7 px-xl-0">
                                        ...
                                        <div class="small d-flex mt-1">
                                            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.notificaciones') }}"
                                                class="text-primary">Ver todas</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-3">
                                        <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.mis-tramites') }}"
                                            ...
                                            style="min-height: 80px;">
                                            <div class="text-center">
                                                @icon('list.checklist', 'fa-lg mb-2')
                                                <div class="fw-bold">Mis Trámites</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3 mb-3">
                                        <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.convocatorias') }}"
                                            class="btn btn-outline-info w-100 d-flex align-items-center justify-content-center"
                                            style="min-height: 80px;">
                                            <div class="text-center">
                                                @icon('calendar.generic', 'fa-lg mb-2')
                                ...
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-warning fw-bold">En validacin</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="fw-bolder text-gray-900">Actualizacin de datos</td>
                                            <td>
                        ...
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body">
                                <div class="list-group list-group-flush">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <div class="icon-shape icon-sm rounded">
                                                    @icon('notif.bell', 'fa-xs text-info')
                                                </div>
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="h6 mb-0 text-small">Tu solicitud requiere
                                                            documentacin adicional</h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="list-group-item px-0 border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <div class="icon-shape icon-sm rounded">
                                                    @icon('state.success', 'fa-xs text-info')
                                                </div>
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="h6 mb-0 text-small">Tu constancia est lista</h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="list-group-item px-0 pb-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <div class="icon-shape icon-sm rounded">
                                                    @icon('state.info', 'fa-xs text-info')
                                                </div>
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="h6 mb-0 text-small">Nueva convocatoria disponible
                                                        </h4>
                                                    </div>
                                                </div>
                                                <p class="font-small mt-1 mb-0">Hace 3 das</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-center mt-3">
                                    <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.notificaciones') }}"
                                        class="btn btn-sm btn-outline-gray-600">Ver todas</a>
                                </div>
                            </div>
                        </div>
                    </div>
