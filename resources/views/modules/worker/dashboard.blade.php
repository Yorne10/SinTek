    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="mb-0">Vista general de tus trmites y notificaciones.</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Trmites en Proceso</h2>
                                <h3 class="fw-extrabold mb-2">3</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
                                Trmites activos pendientes
                            </small>
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Trmites Completados</h2>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.tramites-disponibles') }}" class="btn btn-outline-info w-100 d-flex align-items-center justify-content-center" style="min-height: 80px;">
                                <div class="text-center">
                                    ...
                                    <div class="fw-bold">Nuevo Trmite</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                            <a href="{{ route(config('proj.route_name_prefix', 'proj') . '.worker.mis-tramites') }}" class="btn btn-outline-info w-100 d-flex align-items-center justify-content-center" style="min-height: 80px;">
                                <div class="text-center">
                                    ...
                                    <div class="fw-bold">Mis Trmites</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
            ...
            <div class="card border-0 shadow">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h2 class="fs-5 fw-bold mb-0">Mis Trmites Recientes</h2>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th class="border-bottom" scope="col">Trmite</th>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col ps-0 ms-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h4 class="h6 mb-0 text-small">Tu solicitud requiere documentacin adicional</h4>
                                        </div>
                                    </div>
