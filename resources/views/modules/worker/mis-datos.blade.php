...
<div>
    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="mb-0">Consulta y actualiza tu informacin personal</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="alert alert-info d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>Nota:</strong> Algunos campos no pueden ser modificados directamente. Si necesitas actualizar informacin crtica, contacta al rea de Recursos Humanos.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Informacin personal</h2>
                </div>
                <div class="card-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="apellido_paterno" value="Prez" readonly>
                                <small class="form-text text-muted">Campo no editable</small>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="apellido_materno" class="form-label fw-bold">Apellido materno *</label>
                                <input type="text" class="form-control" id="apellido_materno" value="Garca" readonly>
                                <small class="form-text text-muted">Campo no editable</small>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="estado_civil">
                                    ...
                                    <option value="union_libre">Unin libre</option>
                                </select>
                            </div>
                        </div>
                    </form>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Informacin de contacto</h2>
                </div>
                <div class="card-body">
                    <form>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="telefono" class="form-label fw-bold">Telfono personal</label>
                                <input type="tel" class="form-control" id="telefono" value="(312) 123-4567" placeholder="(312) 123-4567">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="telefono_emergencia" class="form-label fw-bold">Telfono de emergencia</label>
                                <input type="tel" class="form-control" id="telefono_emergencia" value="(312) 987-6543" placeholder="(312) 987-6543">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="email" class="form-label fw-bold">Correo electrnico institucional *</label>
                                <input type="email" class="form-control" id="email" value="juan.perez@cetam.gob.mx" readonly>
                                <small class="form-text text-muted">Campo no editable</small>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="email_personal" class="form-label fw-bold">Correo electrnico personal</label>
                    ...
                    <form>
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" id="calle" value="Av. Tecnolgico" placeholder="Nombre de la calle">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="numero_exterior" class="form-label fw-bold">Nm. exterior</label>
                                <input type="text" class="form-control" id="numero_exterior" value="544" placeholder="123">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="numero_interior" class="form-label fw-bold">Nm. interior</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="codigo_postal" class="form-label fw-bold">Cdigo postal</label>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="estado">
                                    ...
                                    <option value="MICH">Michoacn</option>
                                </select>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <small class="text-muted">Formatos: JPG, PNG. Mx. 2MB</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-0">Informacin de cuenta</h2>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <small class="text-gray-600 fw-bold d-block mb-1">Nmero de empleado</small>
                    ...
                    <div class="mb-3">
                        <small class="text-gray-600 fw-bold d-block mb-1">Antigedad</small>
                        <p class="mb-0">5 aos, 9 meses</p>
                    </div>
                    <div>
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <p class="small text-gray-700 mb-3">Mantn tu cuenta segura actualizando tu contrasea regularmente.</p>
                    <div class="d-grid gap-2">
                    ...
                    <small class="text-muted d-block mt-2">ltima actualizacin: 15/10/2025</small>
                </div>
            </div>
        </div>
    </div>
