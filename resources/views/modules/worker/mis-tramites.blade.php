    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mis trmites</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Mis trmites</h1>
                <p class="mb-0">Consulta el estado de todas tus solicitudes y trmites</p>
            </div>
            <div>
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                ...
                                <small class="text-gray-500">Trmites totales</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                ...
                                <small class="text-gray-500">En revisin</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="input-group">
                                ...
                                <input wire:model.live.debounce.300ms="search" type="text" class="form-control" placeholder="Buscar por ID o tipo de trmite...">
                            </div>
                        </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    <h2 class="fs-5 fw-bold mb-0">Mis trmites ({{ $requests->total() }})</h2>
                </div>
                    ...
                    <table class="table table-centered table-nowrap mb-0 rounded">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">Tipo de trmite</th>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="fw-bold">No tienes trmites</p>
                                        <p class="small">Comienza un nuevo trmite haciendo clic en "Nuevo trmite"</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
                ...
                <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                    ...
                    <div class="fw-normal small mt-4 mt-lg-0">
                        Mostrando <b>{{ $requests->firstItem() ?? 0 }}</b> a <b>{{ $requests->lastItem() ?? 0 }}</b> de <b>{{ $requests->total() }}</b> trmites
                    </div>
                </div>
                @endif
            </div>
