    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nuevo trmite</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Catlogo de trmites</h1>
                <p class="mb-0">Selecciona el trmite que deseas iniciar</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="alert alert-info d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>Informacin importante:</strong> Antes de iniciar un trmite, asegrate de tener toda la documentacin necesaria. Puedes consultar los requisitos en cada trmite.
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Buscar trmite..." wire:model.live="search">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-outline-gray-600 w-100" wire:click="clearFilters">
            ...
            <div class="card border-0 shadow h-100">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <div class="icon-shape icon-sm icon-shape-{{ $proceso->priority == 'alta' ? 'danger' : ($proceso->priority == 'media' ? 'warning' : 'primary') }} rounded me-3">
                            <svg class="icon icon-xs" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12">
            <div class="card border-0 shadow">
                <div class="card-body text-center py-5">
                    <svg class="icon icon-xl text-gray-400 mb-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h4 class="h5 text-gray-600 mb-2">No hay trmites disponibles</h4>
                    <p class="text-gray-500 mb-0">En este momento no hay trmites que coincidan con tu bsqueda.</p>
                </div>
            </div>
        </div>
        @endforelse
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 text-gray-600 small">Si tienes dudas sobre algn trmite, consulta nuestras <a href="#" class="text-primary fw-bold">preguntas frecuentes</a> o contacta al rea de Recursos Humanos.</p>
                        </div>
                    </div>
                </div>
            </div>
